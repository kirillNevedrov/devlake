...
export const ClickUpTransformation = ({ entities, transformation, setTransformation }: Props) => {
      ...
      items={[
        {
          ...
          children: (
            <>
              <p>
                Tell DevLake what your ClickUp tags mean to view metrics such as{' '}
              ...
              <p style={{ marginBottom: 16 }}>
                DevLake defines three standard types of issues: REQUIREMENT, BUG and INCIDENT. Classify your ClickUp
                tasks using tags that match the RegEx patterns below.
              </p>
